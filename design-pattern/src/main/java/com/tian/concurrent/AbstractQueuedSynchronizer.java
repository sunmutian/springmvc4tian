    ...
    *//**
    ...
    static final class Node {
        ...
        *//**
         ...
         *//*
        final java.util.concurrent.locks.AbstractQueuedSynchronizer.Node predecessor() throws NullPointerException {
        ...
        Node(Thread thread, java.util.concurrent.locks.AbstractQueuedSynchronizer.Node mode) {     // Used by addWaiter
        ...
        for (;;) {
            ...
            if (h != null && h != tail) {
                ...
                if (ws == java.util.concurrent.locks.AbstractQueuedSynchronizer.Node.SIGNAL) {
                    if (!compareAndSetWaitStatus(h, java.util.concurrent.locks.AbstractQueuedSynchronizer.Node.SIGNAL, 0))
                        continue;            // loop to recheck cases
                    unparkSuccessor(h);
                }
                else if (ws == 0 &&
                        !compareAndSetWaitStatus(h, 0, java.util.concurrent.locks.AbstractQueuedSynchronizer.Node.PROPAGATE))
        ...
        if (node == tail && compareAndSetTail(node, pred)) {
            ...
            if (pred != head &&
                    ((ws = pred.waitStatus) == java.util.concurrent.locks.AbstractQueuedSynchronizer.Node.SIGNAL ||
                            (ws <= 0 && compareAndSetWaitStatus(pred, ws, java.util.concurrent.locks.AbstractQueuedSynchronizer.Node.SIGNAL))) &&
                    pred.thread != null) {
    ...
    private static boolean shouldParkAfterFailedAcquire(java.util.concurrent.locks.AbstractQueuedSynchronizer.Node pred, java.util.concurrent.locks.AbstractQueuedSynchronizer.Node node) {
        ...
        if (ws > 0) {
            ...
            *//*
             ...
             *//*
            compareAndSetWaitStatus(pred, ws, java.util.concurrent.locks.AbstractQueuedSynchronizer.Node.SIGNAL);
        }
        return false;
    }
    ...
    *//**
    ...
    final boolean transferForSignal(java.util.concurrent.locks.AbstractQueuedSynchronizer.Node node) {
        *//*
         ...
         *//*
        if (!compareAndSetWaitStatus(node, java.util.concurrent.locks.AbstractQueuedSynchronizer.Node.CONDITION, 0))
            return false;
        ...
        *//*
        ...
        int ws = p.waitStatus;
        if (ws > 0 || !compareAndSetWaitStatus(p, ws, java.util.concurrent.locks.AbstractQueuedSynchronizer.Node.SIGNAL))
    ...
    public class ConditionObject implements Condition, java.io.Serializable {
        ...
        *//**
        ...
        private java.util.concurrent.locks.AbstractQueuedSynchronizer.Node addConditionWaiter() {
            ...
            java.util.concurrent.locks.AbstractQueuedSynchronizer.Node node = new java.util.concurrent.locks.AbstractQueuedSynchronizer.Node(Thread.currentThread(), java.util.concurrent.locks.AbstractQueuedSynchronizer.Node.CONDITION);
            if (t == null)
                firstWaiter = node;
            else
                t.nextWaiter = node;
        ...
        *//**
        ...
        public final void await() throws InterruptedException {
            ...
            ////创建一个新的节点，节点状态为condition，采用的数据结构仍然是链
            java.util.concurrent.locks.AbstractQueuedSynchronizer.Node node = addConditionWaiter();
            ...
            // 如果是 null ,就没有什么好清理的了.// clean up if cancelled
    ...
    static {
        try {
            ...
            waitStatusOffset = unsafe.objectFieldOffset
                    (java.util.concurrent.locks.AbstractQueuedSynchronizer.Node.class.getDeclaredField("waitStatus"));
            nextOffset = unsafe.objectFieldOffset
                    (java.util.concurrent.locks.AbstractQueuedSynchronizer.Node.class.getDeclaredField("next"));
